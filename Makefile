...
>  python3 normalize_quality_signals.py --input examples/quality_signal_samples.json >/dev/null; \
>  python3 normalize_quality_signals.py --input examples/quality_signal_samples.json --history "$$store_file" --store >/dev/null; \
>  python3 normalize_quality_signals.py --history "$$store_file" --query latest >/dev/null; \
>  python3 normalize_quality_signals.py --history "$$store_file" --query summary >/dev/null; \
...
>  python3 collect_repo_metrics.py --root "$$tmpdir" --paths a.py b.py c.sh --pretty > "$$tmpdir/repo-metrics.json"; \
>  python3 normalize_quality_signals.py --input "$$tmpdir/repo-metrics.json" --pretty > "$$tmpdir/repo-quality.json"; \
>  python3 normalize_quality_signals.py --input "$$tmpdir/repo-metrics.json" --history "$$repo_store_file" --store >/dev/null; \
>  python3 normalize_quality_signals.py --history "$$repo_store_file" --query latest > "$$latest_file"; \
>  python3 normalize_quality_signals.py --history "$$repo_store_file" --query summary > "$$summary_file"; \
...
>  python3 collect_repo_metrics.py --root "$$tmpdir" --paths sample.py sample_copy.py sample.sh --pretty > "$$tmpdir/out.json"; \
...
>  python3 extract_feature_gap_candidates.py --root . --pretty > "$$json_file"; \
>  python3 extract_feature_gap_candidates.py --root . --format markdown > "$$md_file"; \
...
>  python3 extract_feature_gap_candidates.py --root "$$tmpdir" --pretty > "$$tmpdir/out.json"; \
...
>  md_file="$$(mktemp)"; \
>  trap 'rm -f "$$json_file" "$$md_file"' EXIT; \
>  python3 extract_test_gap_candidates.py --root . --pretty > "$$json_file"; \
>  python3 extract_test_gap_candidates.py --root . --format markdown > "$$md_file"; \
...
>  md_file="$$(mktemp)"; \
>  trap 'rm -f "$$json_file" "$$md_file"' EXIT; \
>  python3 extract_refactor_candidates.py --root . --pretty > "$$json_file"; \
>  python3 extract_refactor_candidates.py --root . --format markdown > "$$md_file"; \

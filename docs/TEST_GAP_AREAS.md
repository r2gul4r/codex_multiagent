...
- 근거:
  - `scripts/collect_repo_metrics.py:62` :: 정의 34개, 연관 테스트 파일 0개
  - `scripts/extract_feature_gap_candidates.py:76` :: 정의 50개, 연관 테스트 파일 0개
  - `scripts/normalize_quality_signals.py:102` :: 정의 38개, 연관 테스트 파일 0개
...
- 근거:
  - `scripts/normalize_quality_signals.py:84` :: coverage 정규화 패턴 정의
  - `scripts/normalize_quality_signals.py:813` :: coverage 입력을 실제 요약 필드로 변환

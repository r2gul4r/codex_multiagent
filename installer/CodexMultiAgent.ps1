...
function Get-ConfigDeveloperInstructionsLines {
    return @(
        ...
        '- Evaluate delegation proactively for read-heavy, parallelizable, or shared-asset work when the efficiency gate passes; if a higher-priority policy blocks a useful spawn, ask for task-scoped approval.',
